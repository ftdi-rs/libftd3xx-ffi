...
#include <pthread.h>
#include "WinTypes.h"
#ifdef WIN_EMU_SELF_CONTAINED
    #include "win-emu.h"
#else
    // Prototypes for functions defined here go in public header
    // of the library incorporating win-emu. e.g. ftd3xx.h
#endif // WIN_EMU_SELF_CONTAINED
