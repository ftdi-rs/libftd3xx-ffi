...
#[test]
fn bindgen_test_layout_FT_PIPE_TRANSFER_CONF() {
    const UNINIT: ::std::mem::MaybeUninit<FT_PIPE_TRANSFER_CONF> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<FT_PIPE_TRANSFER_CONF>(),
        20usize,
        concat!("Size of: ", stringify!(FT_PIPE_TRANSFER_CONF))
    );
    assert_eq!(
        ::std::mem::align_of::<FT_PIPE_TRANSFER_CONF>(),
        4usize,
        concat!("Alignment of ", stringify!(FT_PIPE_TRANSFER_CONF))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).fPipeNotUsed) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(FT_PIPE_TRANSFER_CONF),
            "::",
            stringify!(fPipeNotUsed)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).fNonThreadSafeTransfer) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(FT_PIPE_TRANSFER_CONF),
            "::",
            stringify!(fNonThreadSafeTransfer)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).bURBCount) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(FT_PIPE_TRANSFER_CONF),
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).wURBBufferCount) as usize - ptr as usize },
        10usize,
        concat!(
            "Offset of field: ",
            stringify!(FT_PIPE_TRANSFER_CONF),
            "::",
            stringify!(wURBBufferCount)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).dwURBBufferSize) as usize - ptr as usize },
        12usize,
        concat!(
            "Offset of field: ",
            stringify!(FT_PIPE_TRANSFER_CONF),
            "::",
            stringify!(dwURBBufferSize)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).dwStreamingSize) as usize - ptr as usize },
        16usize,
        concat!(
            "Offset of field: ",
            stringify!(FT_PIPE_TRANSFER_CONF),
            "::",
            stringify!(dwStreamingSize)
        )
    );
}
#[repr(C)]
...
#[test]
fn bindgen_test_layout__FT_TRANSFER_CONF() {
    const UNINIT: ::std::mem::MaybeUninit<_FT_TRANSFER_CONF> = ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<_FT_TRANSFER_CONF>(),
        56usize,
        concat!("Size of: ", stringify!(_FT_TRANSFER_CONF))
    );
    assert_eq!(
        ::std::mem::align_of::<_FT_TRANSFER_CONF>(),
        4usize,
        concat!("Alignment of ", stringify!(_FT_TRANSFER_CONF))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).wStructSize) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(_FT_TRANSFER_CONF),
            "::",
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).fStopReadingOnURBUnderrun) as usize - ptr as usize },
        44usize,
        concat!(
            "Offset of field: ",
            stringify!(_FT_TRANSFER_CONF),
            "::",
            stringify!(fStopReadingOnURBUnderrun)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).fBitBangMode) as usize - ptr as usize },
        48usize,
        concat!(
            "Offset of field: ",
            stringify!(_FT_TRANSFER_CONF),
            "::",
            stringify!(fBitBangMode)
        )
    );
    assert_eq!(
        unsafe {
            ::std::ptr::addr_of!((*ptr).fKeepDeviceSideBufferAfterReopen) as usize - ptr as usize
        },
        52usize,
        concat!(
            "Offset of field: ",
            stringify!(_FT_TRANSFER_CONF),
            "::",
            stringify!(fKeepDeviceSideBufferAfterReopen)
        )
    );
}
